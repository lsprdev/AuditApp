...
function DropdownSelect({
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        {valor
          ? opcoes.find((o) => o[valueKey] == valor)?.[labelKey]
          : placeholder}
        <ChevronDown
          size={16}
          color="#6B0F2B"
          ...
          {opcoes.map((opcao) => (
            <button
              ...
              style={{
                ...
                textAlign: "left",
                background:
                  valor == opcao[valueKey] ? "rgba(107,15,43,0.08)" : "none",
                border: "none",
                cursor: "pointer",
                fontFamily: "var(--font-sans)",
                fontSize: 13,
              ...
              onMouseEnter={(e) =>
                (e.target.style.backgroundColor = "rgba(107,15,43,0.05)")
              }
              onMouseLeave={(e) =>
                (e.target.style.backgroundColor =
                  valor == opcao[valueKey]
                    ? "rgba(107,15,43,0.08)"
                    : "transparent")
              }
            >
...
export default function AuditoriasPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!r.ok) {
        setErro(data.detail || "Erro ao criar auditoria.");
        return;
      }
  ...
  const handleEditar = async (e) => {
    ...
    try {
      const r = await fetch(
        `${BASE}/auditorias/${auditoriaEditando.id_auditoria}/edit/`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
      ...
      const data = await r.json();
      if (!r.ok) {
        setErroEdit(data.detail || "Erro ao editar.");
        return;
      }
  ...
  return (
    <div
      className="auditorias-page app-shell-page"
      style={{
        minHeight: "100vh",
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {auditorias.length} auditoria{auditorias.length !== 1 ? "s" : ""}{" "}
            encontrada{auditorias.length !== 1 ? "s" : ""}
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            <ChevronDown
              ...
              color="#6B0F2B"
              style={{
                transform: formAberto ? "rotate(180deg)" : "rotate(0deg)",
              ...
              >
                <div style={{ gridColumn: "1 / -1" }}>
                  ...
                  <input
                    ...
                    placeholder="Ex: Auditoria LGPD - Filial Norte"
                    style={inputStyle}
                  />
                </div>
                <div>
                  ...
                  <DropdownSelect
                    aberto={empresaAberto}
                    setAberto={setEmpresaAberto}
                    valor={form.id_empresa}
                    setValor={(v) => setForm((p) => ({ ...p, id_empresa: v }))}
                    opcoes={empresas}
                ...
                <div>
                  ...
                  <DropdownSelect
                    aberto={normaAberto}
                    setAberto={setNormaAberto}
                    valor={form.id_norma}
                    setValor={(v) => setForm((p) => ({ ...p, id_norma: v }))}
                    opcoes={normas}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((p) => ({ ...p, data_auditoria: e.target.value }))
                    }
                    style={inputStyle}
                  />
                </div>
                <div style={{ gridColumn: "1 / -1" }}>
                  ...
                  <input
                    ...
                    placeholder="Breve descrição da auditoria"
                    style={inputStyle}
                  />
                </div>
              </div>
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: "transparent",
                    color: "#6B0F2B",
                    border: "1px solid rgba(107,15,43,0.3)",
                    fontFamily: "var(--font-sans)",
                    fontSize: 12,
                    letterSpacing: "2px",
                    textTransform: "uppercase",
          ...
          >
            {auditorias.map((auditoria) => {
              ...
              const podeEditarConcluida =
                isSuperuser || auditoria.pode_editar_concluida;
                ...
                >
                  ...
                  >
                    {[
                      ...
                      <div
                        key={label}
                        style={
                          label === "Descrição" ? { gridColumn: "1 / -1" } : {}
                        }
                      >
                        <p
                          style={{
                  ...
                  >
                    <button
                      ...
                      onMouseEnter={(e) => {
                        if (!concluida)
                          e.currentTarget.style.backgroundColor = "#5a0c24";
                      }}
                      onMouseLeave={(e) => {
                        if (!concluida)
                          e.currentTarget.style.backgroundColor = "#6B0F2B";
                      }}
                    >
                      {concluida ? (
                        <>
                    ...
                    <button
                      ...
                      title={
                        edicaoBloqueada
                          ? "Auditoria concluída só pode ser editada por superuser"
                          : "Editar auditoria"
                      }
                      style={{
                        display: "flex",
                        ...
                        borderRadius: 6,
                        backgroundColor: "transparent",
                        color: edicaoBloqueada
                          ? "rgba(107,15,43,0.25)"
                          : "#6B0F2B",
                        border: edicaoBloqueada
                          ? "1px solid rgba(107,15,43,0.1)"
                          : "1px solid rgba(107,15,43,0.25)",
                        fontFamily: "var(--font-sans)",
                        fontSize: 11,
                        letterSpacing: "2px",
                        textTransform: "uppercase",
                        cursor: edicaoBloqueada ? "not-allowed" : "pointer",
                      }}
                      onMouseEnter={(e) => {
                        if (!edicaoBloqueada)
                          e.currentTarget.style.backgroundColor =
                    ...
                    <button
                      onClick={() =>
                        !concluida && handleDeletar(auditoria.id_auditoria)
                      }
                      disabled={concluida || deletando}
                      title={
                        concluida
                          ? "Auditoria concluída não pode ser excluída"
                          : "Excluir auditoria"
                      }
                      style={{
                        display: "flex",
      ...
      {modalAberto && (
        ...
        >
          ...
          >
            ...
            <div
              style={{ height: 1, backgroundColor: "rgba(107,15,43,0.08)" }}
            />
              ...
              >
                <div style={{ gridColumn: "1 / -1" }}>
                  ...
                  <input
                    ...
                    value={formEdit.nome}
                    onChange={(e) =>
                      setFormEdit((p) => ({ ...p, nome: e.target.value }))
                    }
                    style={inputStyle}
                  />
                </div>
                <div>
                  <label style={labelStyle}>Empresa</label>
                  <DropdownSelect
                    aberto={empresaEditAberto}
                    setAberto={setEmpresaEditAberto}
                    valor={formEdit.id_empresa}
                    setValor={(v) =>
                      setFormEdit((p) => ({ ...p, id_empresa: v }))
                    }
                    opcoes={empresas}
                    placeholder="Selecione a empresa"
                    labelKey="nome"
                ...
                <div>
                  <label style={labelStyle}>Norma</label>
                  <DropdownSelect
                    aberto={normaEditAberto}
                    setAberto={setNormaEditAberto}
                    valor={formEdit.id_norma}
                    setValor={(v) =>
                      setFormEdit((p) => ({ ...p, id_norma: v }))
                    }
                    opcoes={normas}
                    placeholder="Selecione a norma"
                    labelKey="nome"
                ...
                <div>
                  ...
                  <input
                    type="date"
                    required
                    value={formEdit.data_auditoria}
                    onChange={(e) =>
                      setFormEdit((p) => ({
                        ...p,
                        data_auditoria: e.target.value,
                      }))
                    }
                    style={inputStyle}
                  />
                ...
                <div style={{ gridColumn: "1 / -1" }}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormEdit((p) => ({ ...p, descricao: e.target.value }))
                    }
                    style={inputStyle}
                  />
                </div>
