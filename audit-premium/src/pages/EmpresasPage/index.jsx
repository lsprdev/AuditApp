...
export default function EmpresasPage() {
  ...
  const fetchEmpresas = async () => {
    try {
      ...
      const response = await fetch(`${CONTROLES}/empresas/view`, {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem("access_token");
      const response = await fetch(`${CONTROLES}/empresas/create/`, {
        method: "POST",
        headers: {
      ...
      if (!response.ok) {
        ...
        setErro(
          Array.isArray(firstError)
            ? firstError[0]
            : data.detail || "Erro ao cadastrar empresa.",
        );
        return;
      }
  ...
  const salvarEdicao = async (id_empresa) => {
    ...
    try {
      ...
      const response = await fetch(
        `${CONTROLES}/empresas/${id_empresa}/edit/`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const excluirEmpresa = async (id_empresa) => {
    ...
    try {
      const token = localStorage.getItem("access_token");
      await fetch(`${CONTROLES}/empresas/${id_empresa}/delete/`, {
        method: "DELETE",
        headers: { Authorization: `Bearer ${token}` },
      });
      fetchEmpresas();
  ...
  return (
    <div
      className="empresas-page app-shell-page"
      style={{
        minHeight: "100vh",
      ...
      >
        ...
        >
          ...
          >
            ...
            cadastrada{empresas.length !== 1 ? "s" : ""}
          </p>
        </div>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ position: "relative" }}>
                    <button
                      type="button"
                      onClick={() => setPorteAberto(!porteAberto)}
                      style={{
                        ...inputStyle,
                        display: "flex",
                        alignItems: "center",
                        ...
                        borderBottom: "1px solid rgba(107,15,43,0.35)",
                        width: "100%",
                        color: form.porte ? "#6B0F2B" : "rgba(107,15,43,0.35)",
                      }}
                    >
              ...
              >
                ...
                <button
                  ...
                  onMouseLeave={(e) =>
                    (e.target.style.backgroundColor = "#6B0F2B")
                  }
                >
                ...
                {editandoId === empresa.id_empresa ? (
                  ...
                  <>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div style={{ position: "relative" }}>
                          <button
                            type="button"
                            onClick={() => setEditPorteAberto(!editPorteAberto)}
                            style={{
                              ...inputStyle,
                              display: "flex",
                              alignItems: "center",
                    ...
                    >
                      ...
                      <button
                        onClick={() => salvarEdicao(empresa.id_empresa)}
                    ...
                    >
                      ...
                      <div style={{ display: "flex", gap: "8px" }}>
                        ...
                        <button
                          ...
                          disabled={loadingDelete === empresa.id_empresa}
                          title="Excluir"
                          style={{
                            width: "32px",
                            height: "32px",
